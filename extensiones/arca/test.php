...
try {
    $afip = new Wsfev1($CUIT,$MODO);
	echo "<br><br> Cotizacion: ";
    //$result = $afip->consultarCotizacionMoneda("DOL","20250225");  //Con fecha
	$result = $afip->consultarCotizacionMoneda("DOL","");  //Sin fecha
    print_r($result);
	echo "<br><br>";
} catch (Exception $e) {
    echo 'Falló la ejecución: ' . $e->getMessage();
...
try {
    $afip = new Wsfev1($CUIT,$MODO);
	echo "<br><br>Nuevo metodo: <br>";
    $result = $afip->consultarCondicionIVAReceptor();  //Con fecha
	print_r($result);
	echo "<br><br>";
} catch (Exception $e) {
    echo 'Falló la ejecución: ' . $e->getMessage();
