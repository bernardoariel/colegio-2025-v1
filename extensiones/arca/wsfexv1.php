...
class Wsfexv1 extends WsAFIP {
    ...
    private function buildCAEXParams($voucher) {
        ...
        $params->Cmp->Tipo_expo = $voucher["tipo_expo"]; // FEXGetPARAM_Tipo_Expo 
        $params->Cmp->Permiso_existente = $voucher["permiso_existente"]; // Permiso de embarque - S, N, NULL (vacío)
		...
		$params->Cmp->Fecha_pago = $voucher["fecha_Pago"];
        ...
        $params->Cmp->Incoterms = "FOB"; // Cláusula de venta - FEXGetPARAM_Incoterms [N]
        $params->Cmp->Incoterms_Ds = "Test"; // [N]
