...
$pdf->Cell(19,0,$transferencia,0,0,'R');//IMPORTE

$pdf->SetFont('','B');
$pdf->SetXY(38,$altura+25);
...
$pdf->SetXY(60 ,$altura+25);
$pdf->Line(45,$altura+22,79,$altura+22);
